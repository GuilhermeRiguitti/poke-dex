...
const collection = [
  { id: 25, dex: "025", name: "pikachu", types: ["electric"], level: 12, inDeck: true },
  { id: 6, dex: "006", name: "charizard", types: ["fire", "flying"], level: 36, inDeck: false },
  { id: 1, dex: "001", name: "bulbasaur", types: ["grass", "poison"], level: 5, inDeck: false },
  { id: 94, dex: "094", name: "gengar", types: ["ghost", "poison"], level: 28, inDeck: false },
  { id: 130, dex: "130", name: "gyarados", types: ["water", "flying"], level: 30, inDeck: false },
];
...
export default function HoloPreviewPage() {
  return (
    <main className="mx-auto max-w-6xl p-8">
      ...
      <h2 className="mb-3 font-title text-sm uppercase tracking-widest text-ink-dim">
        Abertura de pacote (legendary = foil intenso)
      </h2>
