...
// Uma carta revelada do pacote. A moldura usa a cor da RARIDADE (não do tipo),
// e o lendário ganha aura + foil holográfico mais intenso (HoloCard intense).
//
