...
## Corpus Check
- 256 files · ~120,889 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1056 nodes · 2242 edges · 90 communities (70 shown, 20 thin omitted)
...
Cohesion: 0.09
Nodes (17): duelCalloutFor(), DuelCalloutView, DuelTurnFx, DuelView, DuelStage3D, StageBoundary, StageFallbackSprites(), TONE (+9 more)
...
Cohesion: 0.17
Nodes (12): activeMon(), DuelLogKind, DuelMode, DuelMonView, eventLine(), hpPctOf(), PartyMemberView, prettyName() (+4 more)
...
- **Why does `rarityTier` connect `(game)/page.tsx` to `packs/index.ts`, `battleView.ts`, `deck/index.ts`, `PackOpener.tsx`, `queue/status/route.ts`, `PartyMemberView`, `collectionFilters.ts`, `deckBoardView.ts`, `openPack.ts`, `checkInLogin.ts`, `syncPokedex.ts`, `pokedex/types.ts`, `rarity.ts`, `toDeckBoardDTO.ts`?**
